...
export default class Operation {
    static DIVIDE_OPERATOR = OPERATOR.DIVIDE;
    static MULTIPLY_OPERATOR = OPERATOR.MULTIPLY;
    static SUBTRACT_OPERATOR = OPERATOR.SUBTRACT;
    static SUM_OPERATOR = OPERATOR.SUM;
